...
const allMenus = [
  {
    ...
    label: '用户管理',
    icon: 'TeamOutlined',
    requiredPermissions: ['menu:user-manage'],
  },
  {
    key: 'report',
    label: '数据报表',
    icon: 'BarChartOutlined',
    requiredPermissions: ['menu:report'],
  },
  {
    key: 'settings',
    label: '系统设置',
    icon: 'SettingOutlined',
    requiredPermissions: ['menu:settings'],
  },
  {
    key: 'admin',
    label: '管理员面板',
    icon: 'SafetyOutlined',
    requiredPermissions: ['menu:admin', 'admin:full'],
  },
]
