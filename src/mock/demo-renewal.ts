 ...
 *   GET  /demo/renewal/list        — 列表查询（搜索 / 分页 / 多条件过滤）
 *   GET  /demo/renewal             — 详情查询
 *   POST /demo/renewal             — 新增保源
 *   PUT  /demo/renewal             — 编辑保源
 *   DEL  /demo/renewal             — 删除保源
 *   GET  /demo/renewal/insurers    — 承保公司联想
 */
