 ...
 *
 * 模拟文件上传到磁盘并返回可访问 URL
 * 文件保存到 src/assets/demo-upload/ 目录（demo 前缀，避免与正式项目冲突）
 */
...
const routes: MockRoute[] = [
  // ===== 通用文件上传 =====
  {
    ...
    response: async (req: any) => {
      ...
      return {
        code: 200,
        data: { url: fileUrl, fileName: body.fileName, base64: body.base64 },
        message: '上传成功',
      }
    },
  },
  ...
  // ===== Excel 解析（模拟） =====
  {
    url: '/demo/upload-file/excel/parse',
    method: 'GET',
    response: (req: any) => {
