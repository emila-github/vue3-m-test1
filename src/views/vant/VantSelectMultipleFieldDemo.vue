...
<template>
  <div class="sel-demo">
    <van-nav-bar
      title="VantSelectMultipleField 示例"
      left-text="返回"
      left-arrow
    ...
    <div class="card">
      ...
      />
      <p class="hint">
        当前值（取 value）：<code>{{ city.join(', ') || '（空）' }}</code>
      </p>
    </div>
    ...
    <div class="card">
      ...
      />
      <p class="hint">
        当前值（取 id）：<code>{{ channel.join(', ') || '（空）' }}</code>
      </p>
    </div>
    ...
    <div class="card">
      ...
      />
      <p class="hint">
        当前值（取 code）：<code>{{ raw.join(', ') || '（空）' }}</code>
      </p>
    </div>
