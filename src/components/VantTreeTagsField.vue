...
const showClear = computed(
  () => (props.modelValue ?? []).length > 0 && !props.disabled && !props.readonly,
)
      ...
      <div class="tree-body">
        ...
        >
          ...
          <van-icon
            ...
            :class="[
              'tree-row__check',
              isChecked(row.node[valueKey]) ? 'is-checked' : 'is-unchecked',
              { 'is-disabled': isDisabled(row.node[valueKey], row.hasChildren) },
            ]"
          />
