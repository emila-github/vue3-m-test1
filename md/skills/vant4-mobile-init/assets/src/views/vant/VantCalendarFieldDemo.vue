  ...
  <div class="demo-page">
    ...
    <div class="container">
      ...
      <div class="card">
        ...
        />
        <p class="hint">
          已选：<code>{{ range.length ? range.join(' ~ ') : '（空）' }}</code>
        </p>
      </div>
      ...
      <div class="card">
        ...
        />
        <p class="hint">
          已选：<code>{{ multiple.length ? multiple.join('、') : '（空）' }}</code>
        </p>
      </div>
