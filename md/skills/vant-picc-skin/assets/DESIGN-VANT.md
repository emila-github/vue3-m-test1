...
description: 中国人民财产保险（PICC 保保财险）移动端 Vant4 组件设计系统 v2.0。基于官方 APP 界面截图重新设计，主 CTA 采用 PILL 全圆角药丸按钮，品牌红 #D71920，支持首页红色导航栏变体。以全局 CSS 变量皮肤形式落地，可一键撤销。
---

# PICC 保保财险 · Vant4 设计系统 v2.0（DESIGN-VANT）
