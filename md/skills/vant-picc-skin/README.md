# vant-picc-skin · PICC 保保财险 Vant4 皮肤技能
...
接入后无需改动 App.vue：usePiccSkin 会在开发环境自动注入左下角「PICC 皮肤」悬浮开关，也可用 window.\_\_piccSkin.toggle() 切换。若目标项目没有 main.ts，脚本会打印手动接入提示。
...
- 调用 window.\_\_piccSkin.set(false) 或在悬浮开关点击关闭，移除 <html> 上的 picc-skin class 即可还原原生 Vant4 样式。
